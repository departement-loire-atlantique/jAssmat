...
if(Util.notEmpty(assmat) && Util.notEmpty(request.getParameter("dataId"))){
	...
	%>
	<div class="ajax-refresh-div   ajax-nofocus ajax-noscroll ajaxSelectionPH" style="border-top: dotted 1px #000000">
...
<%	
 ...
 %>
	...
	<a href="plugins/AssmatPlugin/jsp/recherche/selection/doProcessSelection.jsp?dataId=<%= assmat.getId() %>"  class="ajax-refresh removeAM-selection ajax-nofocus ajax-noscroll annuairePH-selection" title="Retirer de ma sélection" data-jalios-ajax-refresh="noscroll nofocus" onclick="return false;"> 
		<span class="jalios-icon jcmsplugin-bookmarks-topbar selection-am" > 
			 <img src="plugins/CorporateIdentityPlugin/images/annuaireph/selectioncheck.jpg"> Retirer de ma sélection 
		</span>	
	</a>
 ...
 <img  class="imgStarGreen"  src="plugins/AssmatPlugin/img/picto-starGreen.png">
	<a href="plugins/AssmatPlugin/jsp/recherche/selection/doProcessSelection.jsp?dataId=<%= assmat.getId() %>"  class="annuairePH-selection ajax-nofocus ajax-noscroll ajax-refresh"  title="Ajouter à ma sélection" data-jalios-ajax-refresh="noscroll nofocus" onclick="return false;"> 
		<span class="jalios-icon jcmsplugin-bookmarks-topbar selection-am" > 
			 <img src="plugins/CorporateIdentityPlugin/images/annuaireph/selectionvide.jpg"> Ajouter à ma sélection
		</span>
	</a>
