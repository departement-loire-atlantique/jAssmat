...
<jsp:useBean id='formHandler' scope='page' class='generated.EditChangementCadreDaccueilHandler'>
...
<%@ include file='/jcore/doMessageBox.jsp' %>
	...
	<div class="saisieDossier form-cg-gray form-cg-white">
		<form action="<%= ServletUtil.getResourcePath(request) %>" method="post">
			<p>Vous devez informer votre unité agrément de toute modification concernant votre cadre d'accueil : agrandissement, travaux, constuction d'une piscine
			ou d'un point d'eau...</p>
