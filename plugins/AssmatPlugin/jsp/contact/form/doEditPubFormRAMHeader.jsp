...
<div>
 ...
 <% String mailValue = encodeForHTML(getUntrustedStringParameter("mailRAM", "")); %>
 <% String titleValue = encodeForHTML(getUntrustedStringParameter("titleRAM", "")); %> 
  
    <div class="box-area form-area" style="margin-left: auto; margin-right: auto;">
      <p class="form-required-text bold"><trsb:glp key="MESSAGE-INTRO-FORMULAIRE-CONTACT-RAM" parameter='<%= new String[]{titleValue, mailValue} %>'></trsb:glp></p>
